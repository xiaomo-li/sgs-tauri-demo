import { WuGuFengDengSkillTrigger } from "../../../ai/skills/cards/wugufengdeng";
...
export class WuGuFengDengSkill
  extends ActiveSkill
  implements ExtralCardSkillProperty
{
  ...
  public async onEffect(
    ...
    const toId = Precondition.exists(
      event.toIds,
      "Unknown targets of wugufengdeng"
    )[0];
    ...
    await room.moveCards({
      movingCards: [
        { card: response.selectedCard, fromArea: CardMoveArea.ProcessingArea },
      ],
      toId,
