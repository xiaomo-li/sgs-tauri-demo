import { FireAttackSkillTrigger } from "../../../ai/skills/cards/fire_attack";
  ...
  implements ExtralCardSkillProperty
{
  ...
  public async onEffect(
    ...
    const toId = Precondition.exists(
      toIds,
      "Unknown targets in fire_attack"
    )[0];
    ...
    const askForDisplayCardEvent =
      EventPacker.createUncancellableEvent<GameEventIdentifiers.AskForCardDisplayEvent>(
        {
          cardAmount: 1,
          toId,
