import { BaseSkillTrigger } from "../ai/skills/base/base_trigger";
...
export const CommonSkill =
  ...
  <T extends Skill>(constructorFunction: SKillConstructor<T>) =>
    onCalculatingSkillUsageWrapper(
      SkillType.Common,
      skill.name,
      skill.description,
...
export function SelfTargetSkill<T extends Skill>(
  constructorFunction: SKillConstructor<T>
) {
  return skillPropertyWrapper(
    {
...
export const ShadowSkill = <T extends Skill>(
  constructorFunction: SKillConstructor<T>
) => {
...
export function SideEffectSkill<T extends Skill>(
  constructorFunction: SKillConstructor<T>
) {
  const WrappedConstructor = skillPropertyWrapper(
    {
...
export function CircleSkill<T extends Skill>(
  constructorFunction: SKillConstructor<T>
) {
  return skillPropertyWrapper(
    {
