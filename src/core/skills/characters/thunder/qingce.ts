...
export class QingCe extends ActiveSkill {
  public canUse(room: Room, owner: Player): boolean {
    return (
      owner.getCardIds(PlayerCardsArea.OutsideArea, ZhengRong.Name).length >
        0 && owner.getCardIds(PlayerCardsArea.HandArea).length > 0
    );
  }
  ...
  public isAvailableCard(
    ...
    return ownerPlayer
      .getCardIds(PlayerCardsArea.OutsideArea, ZhengRong.Name)
      .includes(cardId);
  }
