  ...
  implements OnDefineReleaseTiming
{
  ...
  public breakBaseCardHoldNumber(room: Room, owner: Player) {
    return owner.getFlag<boolean>(LeiYongSi.LeiYongSiCardHold)
      ? owner.LostHp
      : -1;
  }
}
...
@PersistentSkill()
@CompulsorySkill({
  name: LeiYongSiShadow.Name,
  description: LeiYongSiShadow.Description,
})
export class LeiYongSiRemove
