...
export class MingZhe extends TriggerSkill {
  ...
  public canUse(
    ...
    if (
      ...
      >;
      return (
        cardUseOrResponseEvent.fromId === owner.Id &&
        Sanguosha.getCardById(cardUseOrResponseEvent.cardId).isRed()
      );
        ...
        (info) =>
          ...
          info.movingCards.find(
            (cardInfo) =>
              ...
              !cardInfo.asideMove &&
              VirtualCard.getActualCards([cardInfo.card]).find((cardId) =>
