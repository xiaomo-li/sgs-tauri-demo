...
export class ChengLve extends ActiveSkill {
  ...
  public async onEffect(
    ...
    const skillState =
      from.getSwitchSkillState(this.Name) === SwitchSkillState.Yang;
...
@PersistentSkill()
@CommonSkill({
  name: ChengLveShadow.Name,
  description: ChengLveShadow.Description,
})
export class ChengLveBuff
