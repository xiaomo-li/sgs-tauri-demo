...
export class DuoRui extends TriggerSkill implements OnDefineReleaseTiming {
  ...
  public async onEffect(
    ...
    response.selectedOption =
      response.selectedOption || from.AvailableEquipSections[0];
...
@CommonSkill({
  name: "shadow_duorui",
  description: "shadow_duorui_description",
})
export class DuoRuiProhibited
    ...
    if (identifier === GameEventIdentifiers.PhaseChangeEvent) {
      ...
      return (
        ...
        phaseChangeEvent.fromPlayer ===
          owner.getFlag<PlayerId>(DuoRui.DuoRuiTarget)
      );
