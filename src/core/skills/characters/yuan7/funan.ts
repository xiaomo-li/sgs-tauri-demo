...
export class FuNan extends TriggerSkill {
  ...
  public canUse(
    ...
    return (
      ...
      room.isCardOnProcessing(responseToEvent.cardId)
    );
  }
  ...
  public async onEffect(
    ...
    await room.moveCards({
      movingCards: [
        {
          card: (
            cardUseOrResponseEvent.responseToEvent as ServerEventFinder<GameEventIdentifiers.CardEffectEvent>
          ).cardId,
    ...
    room.isCardOnProcessing(cardUseOrResponseEvent.cardId) &&
      (await room.moveCards({
        movingCards: [
          {
            card: cardUseOrResponseEvent.cardId,
            fromArea: CardMoveArea.ProcessingArea,
          },
        ],
        toId: event.fromId,
