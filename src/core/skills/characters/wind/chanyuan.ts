...
import { AllStage, HpChangeStage } from "../../../game/stage_processor";
  ...
  implements OnDefineReleaseTiming
{
  ...
  public skillFilter(
    ...
    return (
      (owner.Hp <= 1 || !!unlimited) &&
      skill.GeneralName !== this.Name &&
      owner.hasSkill(skill.Name)
    );
  }
