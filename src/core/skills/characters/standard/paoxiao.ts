...
@ShadowSkill
@CompulsorySkill({
  name: PaoXiao.GeneralName,
  description: PaoXiao.Description,
})
...
@ShadowSkill
@CompulsorySkill({
  name: PaoXiaoShadow.Name,
  description: PaoXiaoShadow.Description,
})
export class PaoXiaoRemove
  ...
  implements OnDefineReleaseTiming
{
  ...
  public async onEffect(
    ...
    if (identifier === GameEventIdentifiers.DamageEvent) {
      ...
      const additionalDamage = room.getFlag<number>(
        damageEvent.fromId!,
        this.GeneralName
      );
