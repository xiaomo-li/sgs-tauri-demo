...
export class KuangBi extends ActiveSkill {
  ...
  public async onEffect(
    ...
    const originalMapper =
      room.getFlag<KuangBiMapper>(event.fromId, this.Name) || {};
    ...
    room
      ...
      .setFlag<KuangBiMapper>(this.Name, originalMapper);
  ...
  implements OnDefineReleaseTiming
{
  ...
  public async onEffect(
    ...
    const kuangbiMapper = room.getFlag<KuangBiMapper>(
      event.fromId,
      this.GeneralName
    );
    if (kuangbiMapper) {
