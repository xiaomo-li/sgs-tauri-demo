...
import { QuestSkill } from "../../skill_wrappers";
  ...
  public canUse(
    ...
    if (identifier === GameEventIdentifiers.DamageEvent) {
      return (
        ...
        owner
          .getPlayerCards()
          .filter((cardId) => room.canDropCard(owner.Id, cardId)).length > 1
      );
      ...
      return (
        (event as ServerEventFinder<GameEventIdentifiers.PlayerDyingEvent>)
          .dying === owner.Id && owner.Hp < 1
      );
    }
