...
export class BiHuo extends TriggerSkill {
  ...
  public async onEffect(
    ...
    dyingPlayer.hasShadowSkill(BiHuoBuff.Name) ||
      (await room.obtainSkill(dying, BiHuoBuff.Name));
    dyingPlayer.hasShadowSkill(BiHuoRemove.Name) ||
      (await room.obtainSkill(dying, BiHuoRemove.Name));
...
@CommonSkill({
  name: "s_bihuo_remove",
  description: "s_bihuo_remove_description",
})
export class BiHuoRemove extends TriggerSkill {
  ...
  public async onEffect(
    ...
    from.hasShadowSkill(BiHuoBuff.Name) &&
      (await room.loseSkill(event.fromId, BiHuoBuff.Name));
