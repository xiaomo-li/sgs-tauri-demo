...
@CompulsorySkill({
  name: "mou_jiuyuan",
  description: "mou_jiuyuan_description",
})
export class MouJiuYuan extends TriggerSkill {
  ...
  public canUse(
    ...
    if (identifier === GameEventIdentifiers.CardUseEvent) {
      ...
      return (
        ...
        room.getPlayerById(cardUseEvent.fromId).Nationality ===
      ...
      return (
        ...
        room.getPlayerById(aimEvent.fromId).Nationality ===
          CharacterNationality.Wu &&
  ...
  public async onEffect(
    ...
    if (
      ...
      aimEvent.additionalRecoveredHp =
        (aimEvent.additionalRecoveredHp || 0) + 1;
    }
