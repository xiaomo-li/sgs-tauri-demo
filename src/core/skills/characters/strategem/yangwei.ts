...
export class YangWei extends ActiveSkill {
  ...
  public async onEffect(
    ...
    room
      ...
      .setFlag<boolean>(YangWeiRemover.Name, true);
...
@PersistentSkill()
@CommonSkill({
  name: YangWeiShadow.Name,
  description: YangWeiShadow.Description,
})
export class YangWeiRemover
