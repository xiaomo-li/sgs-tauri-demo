...
@CommonSkill({
  name: "decade_yinshi",
  description: "decade_yinshi_description",
})
export class DecadeYinShi extends TriggerSkill {
  ...
  public canUse(
    ...
    content: ServerEventFinder<
      GameEventIdentifiers.DamageEvent | GameEventIdentifiers.JudgeEvent
    >
  ): boolean {
    ...
    if (identifier === GameEventIdentifiers.DamageEvent) {
      ...
      return (
        ...
        (!damageEvent.cardIds ||
          Sanguosha.getCardById(damageEvent.cardIds[0]).Suit ===
            CardSuit.NoSuit)
      );
      ...
      return (
        ...
        room.isCardOnProcessing(judgeEvent.realJudgeCardId)
      );
    }
