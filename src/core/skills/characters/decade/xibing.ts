...
export class XiBing extends TriggerSkill {
  ...
  public async onEffect(
    ...
    const diff =
      Math.min(room.getPlayerById(toId).Hp, 5) -
...
@PersistentSkill()
@CommonSkill({
  name: "s_xibing_blocker",
  description: "s_xibing_blocker_description",
})
...
@PersistentSkill()
@CommonSkill({
  name: "s_xibing_remover",
  description: "s_xibing_remover_description",
})
export class XiBingRemover
