...
export class LiuShi extends ActiveSkill {
  ...
  public isAvailableTarget(
    ...
    return (
      ...
      room
        .getPlayerById(owner)
        .canUseCardTo(room, new CardMatcher({ name: ["slash"] }), target, true)
    );
  }
  ...
  implements OnDefineReleaseTiming
{
  ...
  public canUse(
    ...
    return (
      ...
      Sanguosha.getCardById<VirtualCard>(event.cardIds[0]).findByGeneratedSkill(
        this.GeneralName
      )
    );
  }
