...
import type { FireAttackSkill } from "../../../skills";
...
export class FireAttackSkillTrigger extends ActiveSkillTriggerClass<FireAttackSkill> {
  ...
  skillTrigger = (
    ...
    const otherHandCards = ai
      .getCardIds(PlayerCardsArea.HandArea)
      .filter((card) => card !== skillInCard);
  ...
  onAskForCardDisplayEvent = (
    ...
    | ClientEventFinder<GameEventIdentifiers.AskForCardDisplayEvent>
    | undefined => {
