...
export abstract class PlayerAI {
  ...
  >(content: ServerEventFinder<T>, room: Room): ClientEventFinder<T>;
  protected abstract onAskForPlaceCardsInDileEvent<
  ...
  onAction(
    room: Room,
    e: GameEventIdentifiers,
    content: ServerEventFinder<typeof e>
  ): ClientEventFinder<typeof e> {
    switch (e) {
      ...
      case GameEventIdentifiers.AskForChoosingCardWithConditionsEvent: {
        return this.onAskForChoosingCardWithConditionsEvent(
          content as any,
          room
        );
      }
