...
export const cardDescriptions: Word[] = [
  {
    ...
    target:
      "Once per play phase, use this card to any other player in your attack range. Deal 1 damage to the target.",
  },
  {
  ...
  },
  {
    ...
    target:
      "Use this card in response to any Slash targeting you. The Slash is nullified.",
  },
  {
  ...
  },
  {
    ...
    target:
      "During your play phase, use this card to all players. Target heals 1 HP.",
  },
  {
  ...
  },
  {
    ...
    target:
      "When your used Slash is about to cause damage, you can discard the target 1 mount in his equipment area.",
  },
  {
    source: "qinggang_description",
    target:
      "<b>Compulsory skill</b>, After you use Slash to a target, ignore his armor.",
  },
  {
    source: "qinglongyanyuedao_description",
    target:
      "When your used Slash is nullified by a Jink, you can use another Slash immediately on the same target.",
  },
  {
