...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "You can use club hand card as Iron Chain; your Iron Chain can target to +1 extra player.",
  },
  {
  ...
  {
    source: "huoji_description",
    target: "You can use red cards as Fire Attack.",
  },
  {
    source: "kanpo_description",
    target: "You can use black cards as Nullification.",
  },
  {
...
export const conversations: Word[] = [
  {
    ...
    target:
      "Dual Heroes: do you wanna to obtain slashes played by your opponent?",
  },
];
