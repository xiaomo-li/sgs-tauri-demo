...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "<b>覺醒技</b>，準備階段開始時，若你有不少於三張“田”，你減一點體力上限並獲得“急襲”。",
  },
  {
    source: "jixi_description",
    target: "你可以將一張“田”當【順手牽羊】使用。",
  },
  {
  ...
  },
  {
    ...
    target:
      "出牌階段限一次，你可以令一名其他角色選擇一項：1.對包括你在內的角色使用一張【殺】；2.令你棄置其一張牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你成為【殺】的目標後，你令使用者選擇一項：1.棄置一張基本牌；2.此【殺】對你無效。",
  },
  {
  ...
  },
  {
    ...
    target:
      "出牌階段開始時，你可以令一名角色於本局遊戲中的【樂不思蜀】判定效果反轉。",
  },
  {
    source: "jiang_description",
    target:
      "當你使用【決鬥】或紅色【殺】指定目標後，或成為【決鬥】或紅色【殺】的目標後，你可以摸一張牌。",
  },
  {
    source: "hunzi_description",
    target:
      "<b>覺醒技</b>，準備階段開始時，若你的體力值不大於2，你減1點體力上限並獲得“英魂”和“英姿”。",
  },
  {
  ...
  },
  {
    ...
    target: "<b>鎖定技</b>，當你死亡時，殺死你的角色失去所有技能。",
  },
  {
  ...
  {
    source: "xinsheng_description",
    target: "當你受到1點傷害後，你可以獲得一張“化身”。",
  },
];
