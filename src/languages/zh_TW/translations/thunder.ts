...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "出牌階段，你可以選擇一張“榮”和一張手牌，你獲得此“榮”並棄置此手牌，然後你棄置場上一張牌。",
  },
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你於一回合首次成為【殺】或【決鬥】的目標後，若使用者的手牌數不少於你，此牌對你無效。",
  },
...
export const promptDescriptions: Word[] = [
...

  {
    ...
    target:
      "{0}：你可以選擇一張手牌和一名其他群雄角色，將此牌交給他（可重複 {1} 次）",
  },

  {
    source: "{0}: do you want to give a card to another target?",
    target:
      "{0}：你可以將一張牌交給一名其他角色，然後摸一張牌（若交出裝備牌則改為摸兩張）",
  },
];
