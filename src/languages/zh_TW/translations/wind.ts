...
export const skillDescriptions: Word[] = [
  ...
  {
    source: "shebian_description",
    target: "當你翻面後，你可以移動場上一張裝備牌。",
  },
  {
    source: "jushou_description",
    target:
      "結束階段開始時，你可以翻面並摸四張牌，然後選擇一項：1.棄置一張非裝備牌；2.使用一張裝備牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "當一名角色因另一名角色的棄置或獲得而失去手牌後，你可以失去1點體力。若如此做，失去手牌的角色摸兩張牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "當一名角色的判定牌生效前，你可以打出一張黑色牌替換之。若你打出的牌為黑桃2-9，則你摸一張牌。",
  },
  {
    source: "huangtian_description",
    target:
      "<b>主公技</b>，其他群勢力角色的出牌階段限一次，其可以將一張【閃】或【閃電】交給你。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，你不能質疑“蠱惑”；若你的體力值小於等於1，則你的其他技能失效。",
  },
  {
    source: "#piaoling-select",
    target: "請選擇：1. 將判定牌置於牌堆頂。2. 交給一名角色",
  },
  {
    source: "piaoling: select a player to obtain the judge card",
    target: "飄零：選擇一名角色獲得此判定牌",
  },
];
