...
export const skillDescriptions: Word[] = [
  {
    ...
    target: "當其他角色死亡時，你可以選擇一項：1.獲得其所有牌；2.回複1點體力。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>主公技</b>，當其他魏勢力的黑色判定牌生效後，其可以令你摸一張牌。",
  },
  {
    source: "duanliang_description",
    target:
      "你可以將一張黑色基本或裝備牌當【兵糧寸斷】使用；你對手牌數不小於你的角色使用【兵糧寸斷】無距離限製。",
  },
  {
    source: "jiezi_description",
    target: "<b>鎖定技</b>，當其他角色跳過摸牌階段後，你摸一張牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，【南蠻入侵】對你無效；當其他角色使用的【南蠻入侵】結算結束後，你獲得之。",
  },
  {
    source: "lieren_description",
    target:
      "當你使用【殺】指定目標後，你可以與目標角色拚點，若你：贏，你獲得其一張牌；冇贏，你與其交換拚點牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，結束階段開始時，若你不為體力值最小的角色，你選擇一項：1.失去1點體力；2.減1點體力上限。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，你的回合內，除處於瀕死狀態的角色外的其他角色不能使用【桃】。",
  },
  {
