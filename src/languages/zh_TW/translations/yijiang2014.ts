...
export const skillDescriptions: Word[] = [
...

  {
    ...
    target:
      "當你因棄置而失去一張黑色非錦囊牌後，你可以將此牌當【兵糧寸斷】使用（無距離限制）。",
  },
  {
  ...
  {
    source: "faen_description",
    target: "當一名角色的武將牌翻至正面或橫置後，你可以令其摸一張牌。",
  },
  ...
  },
  {
    ...
    target:
      "當你成爲男性角色使用【殺】或普通錦囊牌的目標後，你可以棄置一張裝備牌，然後該牌對你無效且你獲得此牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "回合結束時，你可以對一至X名其他角色各造成1點傷害（X爲你本回合內跳過的階段數）。",
  },
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你受到傷害後，若此傷害為你於此回合內第一次受到的傷害，你回覆1點體力，否則你失去1點體力。",
  },
  ...
  },
  {
    ...
    target:
      "鎖定技，當你造成或受到傷害時，若你的手牌數為全場唯一最多，此傷害+1。",
  },
];
...
export const promptDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "{0}：你可以移去一張“司”，令 {1} 於此階段內不能使用或打出與此“司”顏色相同的牌",
  },
  ...
  },
  {
    ...
    target:
      "{0}：你可以對 {1} 攻擊範圍內的一名角色使用一張【殺】（無距離限制）",
  },
  ...
  },
  {
    ...
    target:
      "{0}：請將一張牌交給 {1}，併成為 {2} 的使用者，否則你將成為 {2} 的目標",
  },
...

  {
    ...
    target:
      "{0}：請選擇一項：1.將 {1} 裝備區裡的一張牌置入你的裝備區（不替換原裝備）；2.摸一張牌",
  },
...

  {
    ...
    target:
      "{0}：你可對 {2} 攻擊範圍內的至多 {1} 名角色各造成1點傷害，否則 {2} 回覆 {1} 點體力",
  },
  {
