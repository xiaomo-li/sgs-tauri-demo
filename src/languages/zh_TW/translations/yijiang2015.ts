...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "當你受到傷害後，你可以令一名角色判定，若結果爲：紅色，其回覆1點體力；黑色，其摸X張牌（X爲傷害值）。",
  },
  {
  ...
  },
  {
    ...
    target:
      "出牌階段限一次，你可以令一名其他角色於其下個回合開始前受到的下一次傷害+1。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>主公技</b>，<b>鎖定技</b>，你距離爲1的角色視爲在其他吳勢力角色的攻擊範圍內。",
  },
...
export const promptDescriptions: Word[] = [
  {
    ...
    target:
      "{0}：你可以令一名角色判定，若結果為：紅色，其回覆1點體力；黑色，其摸 {1} 張牌",
  },
  ...
  },
  {
    ...
    target:
      "{0}：你可以令 {1} 回覆1點體力，且會在其此次瀕死狀態結束後受到1點無來源傷害",
  },
  ...
  },
  {
    ...
    target:
      "{0}：請棄置 {1} 張手牌，否則 {2} 對你的傷害基數將會+1，且有一定概率不能響應",
  },
  ...
  {
    source: "{0} placed card {1} on the top of draw stack",
    target: "{0} 將 {1} 置於了牌堆頂 ",
  },
