...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "當你受到1點傷害後，你可以令一名角色摸兩張牌，然後若其手牌數小於其體力上限，你摸一張牌。",
  },
  {
    source: "lianhuan_description",
    target:
      "你可以將一張梅花手牌當【鐵索連環】使用或重鑄；你使用【鐵索連環】的目標上限+1。",
  },
  {
  ...
  },
  {
    ...
    target: "<b>鎖定技</b>，若你的裝備區裏冇有防具牌，則視為你裝備【八卦陣】。",
  },
  { source: "huoji_description", target: "你可以將一張紅色牌當【火攻】使用。" },
  {
    source: "kanpo_description",
    target: "你可以將一張黑色牌當【無懈可擊】使用。",
  },
  {
    source: "cangzhuo_description",
    target:
      "<b>鎖定技</b>，棄牌階段開始時，若你本回合未使用過錦囊牌，則你的錦囊牌於本回合內不計入手牌上限。",
  },
  {
  ...
  },
  {
    ...
    target:
      "你可以將兩張花色相同的手牌當【萬箭齊發】使用；你使用【萬箭齊發】可以少選一個目標。",
  },
  {
