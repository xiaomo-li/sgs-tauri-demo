...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "當你受到傷害後，你可以亮出牌堆頂四張牌，然後你獲得其中至少一張點數和不大於13的牌。",
  },
  {
    source: "renxin_description",
    target:
      "當一名其他角色受到傷害時，若其體力值為1，你可以棄置一張裝備牌並翻面，然後防止此傷害。",
  },
  {
  ...
  },
  {
    ...
    target: "當你的拼點結果確定後，若你贏/沒贏，你可以獲得其/你的拼點牌。",
  },
  {
    source: "juece_description",
    target: "結束階段開始時，你可以對本回合失去過牌的一名其他角色造成1點傷害。",
  },
  {
  ...
  },
  {
    ...
    target:
      "當你成為其他角色使用【殺】的目標後，你可以棄置一張牌，然後獲得其裝備區裡的武器牌。",
  },
  {
