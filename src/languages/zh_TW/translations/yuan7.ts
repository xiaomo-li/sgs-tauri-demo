...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "當你受到傷害後，若場上沒有角色處於瀕死狀態，你可以令傷害來源回覆1點體力，然後其隨機棄置其一張裝備牌。",
  },
  {
    source: "hexian_description",
    target:
      "當你回覆體力後，若場上沒有角色處於瀕死狀態，你可以令一名其他角色回覆1點體力，然後其隨機棄置其一張裝備牌。",
  },
...
export const promptDescriptions: Word[] = [
  ...
  { source: "wengua:bottom", target: "置於牌堆底" },
  {
    ...
    target:
      "{0}：你是否要將 {2} 置於牌堆頂或牌堆底，然後你與 {1} 從牌堆另一端各摸一張牌",
  },
  {
    source: "{0}: please choose wengua options: {1} {2}",
    target:
      "{0}：請選擇將 {1} 置於牌堆頂或牌堆底，然後你與 {2} 從牌堆另一端摸一張牌",
  },
  {
    source:
