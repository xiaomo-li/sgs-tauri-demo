...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "每回合限一次，當你成為其他角色使用牌的唯一目標時，你可以判定，若結果點數大於6，取消之。",
  },
  {
...

  {
    ...
    target:
      "<b>鎖定技</b>，結束階段開始時，若你的體力值為奇數，你摸一張牌，否則你回覆1點體力。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你於一回合內首次宣告使用有花色的【殺】後，此【殺】的花色視為方片。",
  },

  {
    source: "xianghai_description",
    target:
      "<b>鎖定技</b>，其他角色的手牌上限-1；你手牌中的裝備牌均視為【酒】。",
  },
  {
