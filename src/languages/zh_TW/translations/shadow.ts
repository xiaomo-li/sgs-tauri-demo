...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "當你使用基本牌或錦囊牌指定第一個目標後，你可以棄置一名不為此牌目標的角色一張牌，然後其摸一張牌。",
  },
  {
    source: "jinqu_description",
    target:
      "結束階段開始時，你可以摸兩張牌，然後將手牌保留至X張（X為你本回合發動過“奇制”的次數）。",
  },

  {
    source: "jianxiang_description",
    target:
      "當你成為其他角色使用牌的目標後，你可以令一名手牌數最少的角色摸一張牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你發動“飛軍”後，若此次“飛軍”的目標於此前未成為過你發動“飛軍”的目標，你摸兩張牌。",
  },
  ...
  },
  {
    ...
    target:
      "出牌階段開始時，你可以選擇一名其他角色，並移去一枚“橘”或失去1點體力，令其獲得一枚“橘”。",
  },
  {
  ...
  },
  {
    ...
    target:
      "當你於一回合首次使用一種類別的非延時類牌結算結束後，你可以將此牌置於牌堆頂，然後摸一張牌。",
  },
  {
...
export const promptDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "{0}：你可以獲得其中一名目標角色一張牌，然後你於本回合內不能對其使用牌",
  },
...

  {
    ...
    target:
      "{0}：你可以令你至多 {1} 名角色各摸一張牌，或對至少一名體力值之和為 {1} 的角色各造成1點傷害",
  },
