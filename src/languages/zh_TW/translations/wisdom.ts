...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "出牌階段限一次，你可以交給一名其他角色一張非基本牌，然後其選擇一項：1.令你回覆1點體力；2.令你摸兩張牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "你的手牌上限等同於體力上限；當你進入瀕死狀態時，你可以棄置兩張牌，回覆1點體力。",
  },

  {
    source: "shameng_description",
    target:
      "出牌階段限一次，你可以棄置兩張顏色相同的手牌，並令一名其他角色摸兩張牌，然後你摸三張牌。",
  },
...

  {
    ...
    target:
      "<b>鎖定技，</b>當一名角色使用裝備牌時，若你的“武庫”標記小於3，你獲得1枚“武庫”標記。",
  },
  {
    source: "zhi_sanchen_description",
    target:
      "<b>覺醒技，</b>結束階段開始時，若你有3枚“武庫”標記，你加1點體力上限，回覆1點體力，獲得技能“滅吳”。",
  },
  {
    source: "miewu_description",
    target:
      "每回合限一次，你可以移去一枚“武庫”標記，並將一張牌當任意基本牌或錦囊牌使用或打出，然後你摸一張牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "準備階段開始時或當你進入瀕死狀態時，你可以廢除一個你的裝備欄，回覆2點體力，然後你可以轉移“輔”標記",
  },
];
