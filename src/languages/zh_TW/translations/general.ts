...
export const eventDictionary: Word[] = [
  ...
  { source: "back to lobby", target: "返回大廳" },
  {
    ...
    target: "內核版本升級至 {0}，下載中...",
  },
  { source: "downloading file {0}/{1}", target: "下載檔案 {0}/{1}" },
  {
    source: "Update complete, please restart client to complete update",
    target: "升級完成，請重啓客戶端完成更新",
  },
  ...
  },
  {
    ...
    target: "請對 {1} 使用一張【{0}】來響應 {2}",
  },
  {
    source: "{0} activated awakening skill {1}",
    target: "{0} 的覺醒技 【{1}】 技能被觸發",
  },
  { source: "{0} used skill {1}", target: "{0} 使用了技能【{1}】" },
  {
    source: "{0} used skill {1} to {2}",
    target: "{0} 使用了技能【{1}】, 目標是 {2}",
  },
  {
  ...
  { source: "{0} used card", target: "{0} 使用" },
  {
    ...
    target: "{0} 使用了技能 【{1}】，打出了一張 {2}",
  },
  {
    source: "{0} used skill {1}, use card {2}",
    target: "{0} 使用了技能 【{1}】，使用了一張 {2}",
  },
  {
    source: "{0} used skill {1}, use card {2} to {3}",
    target: "{0} 使用了技能 【{1}】，使用了一張 {2}，目標是 {3}",
  },
  ...
  {
    source: "{0} used skill {1} to you, please choose",
    target: "{0} 對你使用了技能 【{1}】，請選擇",
  },
  ...
  {
    source: "{0} moved all hand cards out of the game",
    target: "{0} 將所有手牌移出了遊戲",
  },
  {
    source: "{0} use skill {1}, bring {2} to hell",
    target: "{0} 使用了技能 {1}，殺死了 {2}",
  },
  {
  ...
  {
    source: "{0} place card {1} from {2} on the top of draw stack",
    target: "{0} 將 {2} 的 {1} 置於了牌堆頂",
  },
  {
    source: "{0} place card {1} from {2} into equip area of {3}",
    target: "{0} 將 {2} 的 {1} 置於了 {3} 的裝備區",
  },
  { source: "recover {0} hp for {1}", target: "是否回複 {1} {0} 點體力" },
  {
    source: "{0} used skill {1}, damage increases to {2}",
    target: "{0} 使用了技能 【{1}】，傷害增加至 {2} 點",
  },
  {
    source: "{0} triggered skill {1}, damage reduces to {2}",
    target: "{0} 觸發了技能 【{1}】，傷害減少至 {2} 點",
  },
  {
    source: "{0} used skill {1} to you, please present a hand card",
    target: "{0} 使用了技能 【{1}】，請展示一張手牌",
  },
  {
    source: "{0} used {1} to you, please present a hand card",
    target: "{0} 對你使用了 {1}，請展示一張手牌",
  },
  {
    source: "{0} move cards {1} onto the top of {2} character card",
    target: "{0} 將 {1} 置於了 {2} 的武將牌上",
  },
  {
    source: "{0} move {1} cards onto the top of {2} character card",
    target: "{0} 將 {1} 張牌置於了 {2} 的武將牌上",
  },
  {
    source: "{0}: please present a hand card",
    target: "你成為了 {0} 的目標，請展示一張手牌",
  },
  {
    source: "{0} used skill {1}, transfrom {2} into {3}",
    target: "{0} 使用了技能 【{1}】，將 {2} 改為了 {3} 使用",
  },
  {
    source: "{0}: please choose a player to obtain {1}",
    target: "{0}：你可以將 {1} 交給一名角色",
  },
  {
    source: "{0}: please choose a player to drop",
    target: "{0}：你可以棄置攻擊範圍內含有你的一名角色區域內的一張牌",
  },
  {
  ...
  {
    source: "{0} triggered skill {1}, obtained card {2}",
    target: "{0} 觸發了技能 【{1}】，獲得了 {2}",
  },
  {
    source:
  ...
  },
  {
    ...
    target:
      "{0}：請選擇以下一種選項，係統將會亮出牌堆中符合條件的第一張牌，然後你將之交給一名男性角色",
  },
  {
  ...
  },
  {
    ...
    target:
      "放權：你可以棄置一張手牌並選擇一名其他角色，該角色將於回合結束後進行一個額外回合",
  },
  {
    source:
  ...
  },
  {
    ...
    target:
      "請選擇一名角色進行【武魂】的判定，若結果不為【桃】或【桃園結義】，其立即死亡",
  },
  {
  ...
  { source: "please choose your zhiheng cards", target: "請選擇要製衡的牌" },
  {
    ...
    target:
      "請選擇：1.令其受到1點傷害，然後摸X張牌（X為其失去的體力值）。2.令其失去1點體力，然後其獲得你棄置的牌",
  },
  {
    source: "do you wanna transfer the card {0} target to {1}",
    target: "是否將【{0}】的使用目標改為【{1}】",
  },
  {
  ...
  },
  {
    ...
    target:
      "請選擇：1.令 {0} 摸一張牌，然後棄置 {1} 張牌；2.令 {0} 摸 {1} 張牌，然後棄置一張牌",
  },
  {
