...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "一名角色的結束階段開始時，若X不大於你的體力值，你可以摸X張牌（X為你於本回合內失去過的牌數）。",
  },
  {
...

  {
    ...
    target:
      "<b>限定技</b>，出牌階段，若你已受傷，你可以令兩名其他角色交換座次。",
  },
  {
  ...
  },
  {
    ...
    target:
      "一名角色的結束階段開始時，若其手牌數小於其體力值，你可以移去一張“糧”，令其摸兩張牌。",
  },
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你進入瀕死狀態時，若有令你進入瀕死狀態的角色，其棄置一張手牌。",
  },

  {
    source: "jimeng_description",
    target:
      "出牌階段開始時，你可以獲得一名其他角色的一張牌，然後交給其X張牌（X爲你的體力值）。",
  },
  {
    source: "shuaiyan_description",
    target:
      "棄牌階段開始時，若你的手牌數大於1，你可以展示所有手牌，令一名其他角色交給你一張牌。",
  },

  {
    source: "renshi_description",
    target:
      "<b>鎖定技</b>，當你受到【殺】造成的傷害時，若你已受傷，你防止此傷害並獲得此【殺】。",
  },
  {
  ...
  },
  {
    ...
    target:
      "摸牌階段，你可以多摸X+1張牌（X爲你裝備區裏牌數的一半，向下取整）。",
  },
...

  {
    ...
    target:
      "當你於出牌階段內使用牌時，若此牌的顏色與你於此階段內使用過的上一張牌顏色不同，你可以摸一張牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "其他角色的準備階段開始時，若其裝備區裏有牌，你可以對其使用一張無視防具的【殺】。",
  },
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你發動“集兵”使用或打出牌時，若對方是場上體力值最高的角色，你摸一張牌。",
  },
  {
    source: "moucuan_description",
    target:
      "<b>覺醒技</b>，準備階段開始時，若你有至少X張“兵”（X為存活勢力數），你減1點體力上限，然後獲得技能“兵禍”。",
  },
  {
  ...
  },
  {
    ...
    target:
      "當你對其他角色造成傷害時，你可以令此傷害-1，然後你獲得其裝備區裡的一張牌。",
  },
  {
    source: "qishe_description",
    target:
      "你可以將一張裝備牌當【酒】使用；你的手牌上限+X（X為你裝備區裡的牌數）。",
  },
];
...
export const promptDescriptions: Word[] = [
...

  {
    ...
    target:
      "{0}；你可以發動本技能，棄置所有手牌，令 {1} 回覆體力至1點，然後對當前回合角色造成1點傷害",
  },

  {
    source: "jimeng {0}: do you want to prey a card from another player?",
    target:
      "{0}；你可以獲得一名其他角色一張牌，然後交給其等同於你體力值數量的牌",
  },
  {
