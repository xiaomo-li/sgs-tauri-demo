...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "結束階段開始時，你可以摸X張牌，然後可將等量手牌交給一名其他角色（X為你已損失的體力值）。",
  },
  ...
  },
  {
    ...
    target:
      "當你受到傷害後，你可以摸一張牌並展示所有手牌，若這些牌顏色均相同，傷害來源棄置一張手牌。",
  },
  ...
  },
  {
    ...
    target:
      "覺醒技，準備階段開始時，若你有不少於3張“權”，你減1點體力上限，回覆1點體力或摸兩張牌，然後獲得技能“排異”。",
  },
  {
    source: "paiyi_description",
    target:
      "出牌階段限一次，你可以移去一張“權”，令一名其他角色摸兩張牌，然後若其手牌數大於你，你對其造成1點傷害。",
  },
...

  {
    ...
    target:
      "<b>鎖定技</b>，回合開始時，你從棄牌堆中隨機獲得一張【殺】，執行一個額外的出牌階段。",
  },
  {
  ...
  },
  {
    ...
    target:
      "當你死亡時，你可以令除殺死你的角色外的一名其他角色摸三張牌並回復1點體力。",
  },
