...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "當其他角色的判定牌進入棄牌堆後，或其他角色的牌因棄置而進入棄牌堆後，你可以獲得其中至少一張梅花牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "你對其他角色造成傷害時，你可以防止此傷害，然後獲得其區域內的一張牌。",
  },
...

  {
    ...
    target:
      "<b>鎖定技</b>，當你使用錦囊牌造成傷害時，或你受到錦囊牌造成的傷害時，防止此傷害。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>鎖定技</b>，當你於回合外受到傷害後，本回合內【殺】和普通錦囊牌對你無效。",
  },
  ...
  },
  {
    ...
    target:
      "若你於棄牌階段內棄置過至少兩張手牌，或當你失去裝備區裡的牌後，你可以依次棄置其他角色的共計一至兩張牌。",
  },
];
...
export const promptDescriptions: Word[] = [
  {
    ...
    target:
      "{0}：你需交給 {1} 一張手牌（若不爲紅桃則 {1} 摸一張牌），否則失去1點體力",
  },
  ...
  { source: "xuanhuo:give", target: "選項二" },
  {
    ...
    target:
      "{0}：選項一：視爲對 {1} 使用一張任意【殺】或【決鬥】；選項二：交給 {2} 所有手牌",
  },
  {
  ...
  },
  {
    ...
    target:
      "{0}：你可以棄置一張非基本牌並選擇一名其他角色，其選擇摸牌、回血或復原",
  },
  {
    source:
      "{0}: do you want to drop a card except basic card and choose a target",
...

  {
    ...
    target:
      "{0}：你可以展示 {1} 的一張手牌，若此牌不爲基本牌，其棄置之並回復1點體力",
  },
  {
