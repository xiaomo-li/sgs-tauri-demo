...
export const skillDescriptions: Word[] = [
...

  {
    ...
    target:
      "当你因弃置而失去一张黑色非锦囊牌后，你可以将此牌当【兵粮寸断】使用（无距离限制）。",
  },
  {
  ...
  },
  {
    ...
    target: "当一名角色的武将牌翻至正面或横置后，你可以令其摸一张牌。",
  },
  ...
  },
  {
    ...
    target:
      "当你成为男性角色使用【杀】或普通锦囊牌的目标后，你可以弃置一张装备牌，然后该牌对你无效且你获得此牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "回合结束时，你可以对一至X名其他角色各造成1点伤害（X为你本回合内跳过的阶段数）。",
  },
  ...
  },
  {
    ...
    target:
      "<b>锁定技</b>，当你受到伤害后，若此伤害为你于此回合内第一次受到的伤害，你回复1点体力，否则你失去1点体力。",
  },
...
export const promptDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "{0}：你可以移去一张“司”，令 {1} 于此阶段内不能使用或打出与此“司”颜色相同的牌",
  },
  ...
  },
  {
    ...
    target:
      "{0}：你可以对 {1} 攻击范围内的一名角色使用一张【杀】（无距离限制）",
  },
  ...
  },
  {
    ...
    target:
      "{0}：请将一张牌交给 {1}，并成为 {2} 的使用者，否则你将成为 {2} 的目标",
  },
...

  {
    ...
    target:
      "{0}：请选择一项：1.将 {1} 装备区里的一张牌置入你的装备区（不替换原装备）；2.摸一张牌",
  },
...

  {
    ...
    target:
      "{0}：你可对 {2} 攻击范围内的至多 {1} 名角色各造成1点伤害，否则 {2} 回复 {1} 点体力",
  },
  {
