...
export const eventDictionary: Word[] = [
  ...
  { source: "{0} used card", target: "{0} 使用" },
  {
    ...
    target: "{0} 使用了技能 【{1}】，打出了一张 {2}",
  },
  {
    source: "{0} used skill {1}, use card {2}",
    target: "{0} 使用了技能 【{1}】，使用了一张 {2}",
  },
  {
    source: "{0} used skill {1}, use card {2} to {3}",
    target: "{0} 使用了技能 【{1}】，使用了一张 {2}，目标是 {3}",
  },
  ...
  },
  {
    ...
    target:
      "{0}：请选择以下一种选项，系统将会亮出牌堆中符合条件的第一张牌，然后你将之交给一名男性角色",
  },
  {
  ...
  { source: "please choose your zhiheng cards", target: "请选择要制衡的牌" },
  {
    ...
    target:
      "请选择：1.令其受到1点伤害，然后摸X张牌（X为其失去的体力值）。2.令其失去1点体力，然后其获得你弃置的牌",
  },
  {
    source: "do you wanna transfer the card {0} target to {1}",
    target: "是否将【{0}】的使用目标改为【{1}】",
  },
  {
  ...
  },
  {
    ...
    target:
      "请选择：1.令 {0} 摸一张牌，然后弃置 {1} 张牌；2.令 {0} 摸 {1} 张牌，然后弃置一张牌",
  },
  {
