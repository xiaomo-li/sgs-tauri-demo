...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "当你使用基本牌或锦囊牌指定第一个目标后，你可以弃置一名不为此牌目标的角色一张牌，然后其摸一张牌。",
  },
  {
    source: "jinqu_description",
    target:
      "结束阶段开始时，你可以摸两张牌，然后将手牌保留至X张（X为你本回合发动过“奇制”的次数）。",
  },

  {
    source: "jianxiang_description",
    target:
      "当你成为其他角色使用牌的目标后，你可以令一名手牌数最少的角色摸一张牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "<b>锁定技</b>，当你发动“飞军”后，若此次“飞军”的目标于此前未成为过你发动“飞军”的目标，你摸两张牌。",
  },
  ...
  },
  {
    ...
    target:
      "出牌阶段开始时，你可以选择一名其他角色，并移去一枚“橘”或失去1点体力，令其获得一枚“橘”。",
  },
  {
  ...
  },
  {
    ...
    target:
      "当你于一回合首次使用一种类别的非延时类牌结算结束后，你可以将此牌置于牌堆顶，然后摸一张牌。",
  },
  {
...
export const promptDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "{0}：你可以获得其中一名目标角色一张牌，然后你于本回合内不能对其使用牌",
  },
...

  {
    ...
    target:
      "{0}：你可以令至多 {1} 名角色各摸一张牌，或对至少一名体力值之和为 {1} 的角色各造成1点伤害",
  },
