...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "出牌阶段，你可以选择一张“荣”和一张手牌，你获得此“荣”并弃置此手牌，然后你弃置场上一张牌。",
  },
  ...
  },
  {
    ...
    target:
      "<b>锁定技</b>，当你于一回合首次成为【杀】或【决斗】的目标后，若使用者的手牌数不少于你，此牌对你无效。",
  },
...
export const promptDescriptions: Word[] = [
...

  {
    ...
    target:
      "{0}：你可以选择一张手牌和一名其他群雄角色，将此牌交给他（可重复 {1} 次）",
  },

  {
    source: "{0}: do you want to give a card to another target?",
    target:
      "{0}：你可以将一张牌交给一名其他角色，然后摸一张牌（若交出装备牌则改为摸两张）",
  },
];
