...
export const skillDescriptions: Word[] = [
  ...
  },
  {
    ...
    target:
      "当一名角色使用普通锦囊牌指定第一个目标后，若目标数大于1，你可以对一名其他角色造成1点伤害。",
  },
  ...
  },
  {
    ...
    target:
      "出牌阶段限一次，你可以将所有手牌当【南蛮入侵】使用；当有角色受到【南蛮入侵】造成的伤害后，你摸一张牌。",
  },
  {
...
export const promptDescriptions: Word[] = [
  ...
  {
    source: "yuyun:damage",
    target: "对一名其他角色造成1点伤害，且本回合对其无限出杀",
  },
  ...
  {
    source:
      "zhanyuan: do you want to choose another male character to gain ‘Xi Li’ with him?",
...

  {
    ...
    target:
      "{0}：你可以弃置一张牌，令 {1} 对 {2} 造成的伤害+1，然后你与 {1} 各摸两张牌",
  },
  {
    source:
