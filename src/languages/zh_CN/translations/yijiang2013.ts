...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "当你受到伤害后，你可以亮出牌堆顶四张牌，然后你获得其中至少一张点数和不大于13的牌。",
  },
  {
    source: "renxin_description",
    target:
      "当一名其他角色受到伤害时，若其体力值为1，你可以弃置一张装备牌并翻面，然后防止此伤害。",
  },
  {
  ...
  {
    source: "j3_zongshi_description",
    target: "当你的拼点结果确定后，若你赢/没赢，你可以获得其/你的拼点牌。",
  },
  {
    source: "juece_description",
    target: "结束阶段开始时，你可以对本回合失去过牌的一名其他角色造成1点伤害。",
  },
  {
  ...
  },
  {
    ...
    target:
      "当你成为其他角色使用【杀】的目标后，你可以弃置一张牌，然后获得其装备区里的武器牌。",
  },
  {
