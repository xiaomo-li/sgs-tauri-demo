...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "出牌阶段限一次，你可以交给一名其他角色一张非基本牌，然后其选择一项：1.令你回复1点体力；2.令你摸两张牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "你的手牌上限等同于体力上限；当你进入濒死状态时，你可以弃置两张牌，回复1点体力。",
  },

  {
    source: "shameng_description",
    target:
      "出牌阶段限一次，你可以弃置两张颜色相同的手牌，并令一名其他角色摸两张牌，然后你摸三张牌。",
  },
...

  {
    ...
    target:
      "<b>锁定技，</b>当一名角色使用装备牌时，若你的“武库”标记小于3，你获得1枚“武库”标记。",
  },
  {
    source: "zhi_sanchen_description",
    target:
      "<b>觉醒技，</b>结束阶段开始时，若你有3枚“武库”标记，你加1点体力上限，回复1点体力，获得技能“灭吴”。",
  },
  {
    source: "miewu_description",
    target:
      "每回合限一次，你可以移去一枚“武库”标记，并将一张牌当任意基本牌或锦囊牌使用或打出，然后你摸一张牌。",
  },
  {
  ...
  },
  {
    ...
    target:
      "准备阶段开始时或当你进入濒死状态时，你可以废除一个你的装备栏，回复2点体力，然后你可以转移“辅”标记",
  },
];
...
export const promptDescriptions: Word[] = [
  ...
  {
    source: "{0}: please choose and abort an equip section",
    target: "{0}: 请选择废除一个装备区",
  },
  {
    source:
