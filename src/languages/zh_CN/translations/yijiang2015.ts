...
export const skillDescriptions: Word[] = [
  {
    ...
    target:
      "当你受到伤害后，你可以令一名角色判定，若结果为：红色，其回复1点体力；黑色，其摸X张牌（X为伤害值）。",
  },
  {
...
export const promptDescriptions: Word[] = [
  {
    ...
    target:
      "{0}：你可以令一名角色判定，若结果为：红色，其回复1点体力；黑色，其摸 {1} 张牌",
  },
  ...
  },
  {
    ...
    target:
      "{0}：你是否令 {1} 回复1点体力，且会在其此次濒死状态结束后受到1点无来源伤害",
  },
  ...
  },
  {
    ...
    target:
      "{0}：请弃置 {1} 张手牌，否则 {2} 对你的伤害基数将会+1，且有一定概率不能响应",
  },
