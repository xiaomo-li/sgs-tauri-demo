...
export const skillDescriptions: Word[] = [
...

  {
    ...
    target:
      "<b>限定技</b>，出牌阶段，你可以获得至多X名其他角色的各一张手牌（X为你的体力值）。",
  },
  {
...

  {
    ...
    target:
      "<b>锁定技</b>，准备阶段开始时，你横置，然后无论你是否横置，你横置任意名与你体力值相等的角色。",
  },
  {
...

  {
    ...
    target:
      "出牌阶段，你可以与一名角色拼点。若你没赢，其摸两张牌，且本技能于此阶段内失效。",
  },
  {
...

  {
    ...
    target:
      "出牌阶段开始时，你可以将一名其他角色判定区里的一张牌移至你的判定区。",
  },
  {
    source: "liangjue_description",
    target:
      "<b>锁定技</b>，当黑色牌进入或离开你的判定区或装备区后，若你的体力值大于1，你失去1点体力，然后摸两张牌。",
  },
  ...
  },
  {
    ...
    target:
      "<b>锁定技</b>，当你于回合外成为【杀】或普通锦囊牌的目标后，若你没有手牌，你摸两张牌。",
  },
...

  {
    ...
    target:
      "摸牌阶段开始时，若你不为场上手牌最多的角色，你可以令至多两名角色各摸一张牌。",
  },
  {
...
export const promptDescriptions: Word[] = [
...

  {
    ...
    target:
      "{0}：你可以从牌堆和弃牌堆中（优先从牌堆）随机将一张【无中生有】置于牌堆顶",
  },
  {
