...
const cosRepo: string =
  "https://sgs-static-1256205614.cos.ap-nanjing.myqcloud.com/backup_remote";
...
export class DevImageLoader implements ImageLoader {
  ...
  public getCardBack() {
    return {
      src: `${cosRepo}/images/cards/cardback.webp`,
      alt: "New QSanguosha",
    };
  }
  ...
  getDelayedTricksImage(cardName: string) {
    return {
      src: `${cosRepo}/images/delayed_tricks/${cardName}.png`,
      alt: cardName,
    };
  }
  ...
  public async getOthersEquipCard(cardName: string) {
    return {
      src: `${cosRepo}/images/others_equips/${cardName}.png`,
      alt: cardName,
    };
  }
  ...
  public getWaitingRoomBackgroundImage() {
    return {
      alt: "",
      src: `${cosRepo}/images/system/waiting_room_background.jpg`,
    };
  }
  ...
  public async getSlimAbortedEquipSection(section: CharacterEquipSections) {
    ...
    const image: string = (
      await import(`${cosRepo}/images/slim_equips/${sectionName}.png`)
    ).default;
  ...
  public async getSlimEquipCard(cardName: string) {
    return {
      src: `${cosRepo}/images/slim_equips/${cardName}.png`,
      alt: "Slim Equip Card",
    };
  }
  ...
  public async getSlimCard(cardName: string) {
    return {
      src: `${cosRepo}/images/slim_cards/${cardName}.png`,
      alt: "Slim Card",
    };
  }
  ...
  public getGameModeIcon(mode: GameMode) {
    return {
      src: `${cosRepo}/images/lobby/${gameModeIcons[mode]}.png`,
      alt: "",
    };
  }
