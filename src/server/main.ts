...
class App {
  ...
  constructor(
    ...
    private lobbyEventChannel: LobbyEventChannel
  ) {}
...
const roomService = new RoomService(
  lobbySocket,
  (roomChannel: SocketIO.Namespace, roomId: RoomId) =>
    new ServerSocket(roomChannel, roomId, logger),
  (
    roomId: RoomId,
    gameInfo: GameInfo,
    socket: ServerSocket,
...
new App(
  config,
  logger,
  new LobbyEventChannel(roomService, lobbySocket, config)
).start();
