...
exports.BingLiangCunDuanSkillTrigger = void 0;
const ai_lib_1 = require("core/ai/ai_lib");
const active_skill_trigger_1 = require("core/ai/skills/base/active_skill_trigger");
class BingLiangCunDuanSkillTrigger extends active_skill_trigger_1.ActiveSkillTriggerClass {
    constructor() {
        super(...arguments);
...
exports.BingLiangCunDuanSkillTrigger = BingLiangCunDuanSkillTrigger;
