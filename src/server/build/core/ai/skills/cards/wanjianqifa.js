...
exports.WanJianQiFaSkillTrigger = void 0;
const ai_lib_1 = require("core/ai/ai_lib");
const active_skill_trigger_1 = require("core/ai/skills/base/active_skill_trigger");
class WanJianQiFaSkillTrigger extends active_skill_trigger_1.ActiveSkillTriggerClass {
    constructor() {
        super(...arguments);
...
exports.WanJianQiFaSkillTrigger = WanJianQiFaSkillTrigger;
