...
class AudioPlayerService implements AudioService {
  ...
  async playSkillAudio(
    ...
    try {
      ...
      if (skinName) {
        ...
        const audioUrl = await this.loader.getSkillAudio(
          skillName,
          gender,
          characterName,
          audioIndex
  ...
  async playCardAudio(
    ...
    try {
      const audioUrl = await this.loader.getCardAudio(
        cardName,
        gender,
        characterName
      );
  ...
  private async play(
    ...
    audio.volume = audio.volume = volumeString
      ? this.getFixedVolume(volumeString)
      : 0.5;
  }
...
export function installAudioPlayerService(
