...
export class CharacterCard extends React.Component<CharacterCardProps> {
  ...
  @mobx.action
  async updataCharacterImage() {
    this.characterImage = await this.props.imageLoader.getCharacterImage(
  ...
  async componentDidMount() {
    this.characterImage = (
      await this.props.imageLoader.getCharacterImage(this.props.character.Name)
    ).src;
  }
  ...
  render() {
    const { character, translator, className, size, selected, onClick } =
      this.props;
    return (
      <div
