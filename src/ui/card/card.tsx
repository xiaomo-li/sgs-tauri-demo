...
import { CardDescription } from "../card_description/card_description";
    ...
    return (
      <div
        className={classNames(styles.innerCard, {
          [styles.disabled]:
            highlight === undefined ? this.props.disabled : !highlight,
        })}
      >
        {this.originalCard && (
          <div className={styles.cornerTag}>
            <CardNumberItem
              cardNumber={this.originalCard.CardNumber}
              isRed={this.originalCard.isRed()}
            />
