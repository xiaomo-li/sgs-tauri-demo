...
export class GameDialog extends React.Component<GameDialogProps> {
  ...
  componentDidUpdate() {
    if (this.dialogElementRef.current) {
      this.dialogElementRef.current.scrollTop =
        this.dialogElementRef.current.scrollHeight;
    }
  }

  private readonly onBorderDown = (
  ...
  private readonly onBorderMove = (e: MouseEvent) => {
    ...
    const height =
      this.dialogElementRef.current!.clientHeight - this.fixedHeight;
    this.dialogHeight = {
      height,
    };
  };
