...
export class PlayerCard extends React.Component<PlayerCardProps> {
  ...
  get PlayerCharacter() {
    ...
    try {
      return this.props.player.CharacterId !== undefined
            ...
            .map(([areaName, cards], index) =>
              cards.length === 0 ? undefined : (
                <span
                  ...
                  onClick={
                    player!.isOutsideAreaVisible(areaName)
                      ? this.onOutsideAreaTagClicked(areaName, cards)
                      : undefined
                  }
                >
  ...
  private renderCharacterImage() {
    if (this.PlayerCharacter && this.props.player) {
      if (this.props.skinData) {
        ...
        this.props.imageLoader
          .getCharacterImage(this.PlayerCharacter.Name)
          .then((image) => {
      ...
      const huashenCharacterId =
        this.props.player?.getHuaShenInfo()?.characterId;
      ...
      if (huashenCharacter) {
        this.props.imageLoader
          .getCharacterImage(huashenCharacter.Name, this.props.player?.Id)
          .then((image) => {
      ...
      >
        ...
        >
            ...
            <>
              <p
                className={classNames(styles.playerName, {
                  ...
                  [styles.autoHide]:
                    this.PlayerCharacter && this.autoHidePlayerName,
                })}
              >
                {player.Name}
              </p>
              {this.PlayerCharacter ? (
                <>
                  ...
                  {this.props.player &&
                    this.props.player.CharacterId !== undefined && (
                      <NationalityBadge
                  ...
                  {player.Role !== PlayerRole.Unknown && (
                    <Mask
                      ...
                      lockedRole={
                        this.isPlayerRoleLocked(player)
                          ? player.Role
                          : undefined
                      }
                    />
                  ...
                  >
                    ...
                    {this.showPlayerHandcards &&
                      this.focusedOnPlayerHandcard &&
                      this.props.player && (
                        <Tooltip
          ...
          <div className={styles.playerTags}>
            {this.props.presenter.ClientPlayer &&
              this.getSkillTags(this.props.presenter.ClientPlayer.Id)}
...
class PlayerAbortedEquipSection extends React.Component<PlayerAbortedEquipSectionProps> {
  ...
  async componentDidMount() {
    this.abortedImageProp =
      await this.props.imageLoader.getOthersAbortedEquipCard();
  }
