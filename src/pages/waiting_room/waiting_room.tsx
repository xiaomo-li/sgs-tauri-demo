...
export class WaitingRoom extends React.Component<WaitingRoomProps> {
  ...
  private selfPlayerName =
    this.props.electronLoader.getData<string>(ElectronData.PlayerName) ||
    this.props.translator.tr("unknown");
  private roomName: string;

  private presenter = new WaitingRoomPresenter();
  private store: WaitingRoomStore = this.presenter.createStore(
    this.selfPlayerId
  );
  ...
  constructor(props: WaitingRoomProps) {
    ...
    const { match, electronLoader, translator, imageLoader, audioLoader } =
      this.props;
  ...
  private get validSettings() {
    const allPlayers = this.store.seats.filter(
  ...
  render() {
    ...
    return (
      <div className={styles.waitingRoom}>
        <Background
          image={this.props.imageLoader.getWaitingRoomBackgroundImage()}
        />
        <HeaderBar
          {...props}
        ...
        <div className={styles.mainContainer}>
          <div className={styles.playersPanel}>
            ...
            <ChatBox
              ...
              presenter={this.presenter}
              store={this.store}
              playerName={this.props.electronLoader.getData(
