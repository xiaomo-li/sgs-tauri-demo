...
export class GameSettings extends React.Component<GameSettingsProps> {
  ...
  private get getGameModeOptions() {
    return [
      ...
      },
      {
        ...
        checked:
          this.props.store.gameSettings.gameMode === GameMode.OneVersusTwo,
        disabled: !this.props.controlable,
      },
      {
        ...
        checked:
          this.props.store.gameSettings.gameMode === GameMode.TwoVersusTwo,
        disabled: !this.props.controlable,
      },
      {
  ...
  private get gameCharacterExtensions() {
    return Sanguosha.getGameCharacterExtensions().map((extension) => ({
      ...
      checked:
        this.props.store.gameSettings.characterExtensions.includes(extension),
      disabled:
        extension === GameCharacterExtensions.Standard ||
  ...
  @mobx.action
  private readonly onCheckedPveSpecifiedGameMode = (
        ...
        this.searchResultList = Sanguosha.getCharacterByExtensions(
          ...
          (character) =>
            ...
            this.props.translator
              .tr(character.Name)
              .includes(this.searchCharacterInput)
        );

        if (this.searchContentElementRef.current) {
          const { left } =
            this.searchContentElementRef.current.getBoundingClientRect();
          this.searchTooltipPosition = [
  ...
  private readonly addOrRemoveForbiddenCharactersById = (
    character: Character
  ) => {
    ...
    this.props.presenter.updateGameSettings(this.props.store, {
      ...this.props.store.gameSettings,
      excludedCharacters:
        this.props.store.gameSettings.excludedCharacters.includes(character.Id)
          ? this.props.store.gameSettings.excludedCharacters.filter(
    ...
    return (
      <div className={classNames(styles.container, this.props.className)}>
        ...
        <div className={styles.settingsLabel}>
          ...
          <div
            className={classNames(styles.inputLabel, styles.horizontalInput)}
          >
            <div>
              <Text
                className={styles.inputTitle}
        ...
        <div
          ...
          ref={this.searchContentElementRef}
        >
          <Text
            className={styles.inputTitle}
            color="white"
          ...
          {this.searchResultList.length > 0 && this.searchTooltipPosition && (
            <Tooltip
              position={{
                bottom: this.searchTooltipPosition[1],
                right: this.searchTooltipPosition[0],
              }}
          ...
          <div className={styles.searchResultsList}>
            {this.props.store.gameSettings.excludedCharacters.map(
              (characterId) => (
                <CharacterCard
                  key={characterId}
