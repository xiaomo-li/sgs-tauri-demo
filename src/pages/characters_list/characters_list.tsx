...
export class CharactersList extends React.Component<CharactersListProps> {
  ...
  private characterExtensionOptions =
  ...
  @mobx.observable.deep
  private nationalityOptions = Sanguosha.getNationalitiesList().map(
    (nationality) => ({
      label: this.props.translator.tr(
  ...
  private checkedExtensions: GameCharacterExtensions[] =
    Sanguosha.getGameCharacterExtensions();
  @mobx.observable.shallow
  private selectedNationalities: CharacterNationality[] =
  ...
  @mobx.action
  private readonly onCheckNationality = (
    nationalities: CharacterNationality[]
  ) => {
  ...
  private get Characters() {
    return CharacterLoader.getInstance()
      ...
      .filter((character) =>
        this.selectedNationalities.includes(character.Nationality)
      );
  }
  ...
  private readonly onHoverCharacter = (characterId: CharacterId) => () => {
    ...
    this.focusedSkinName = Sanguosha.getCharacterById(
            ...
            {this.focusedCharacterId !== undefined && (
              ...
              >
                <CharacterSkinCard
                  ...
                  character={Sanguosha.getCharacterById(
                    this.focusedCharacterId
                  )}
