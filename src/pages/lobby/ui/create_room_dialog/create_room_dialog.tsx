...
export class CreateRoomDialog extends React.Component<{
  ...
  private username: string = this.props.electronLoader.getData(
  ...
  private allowAllCharacters: boolean =
    this.props.electronLoader.getData(
  ...
  private readonly onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    this.props.onSubmit(
      {
        hostPlayerId: this.props.electronLoader.getTemporaryData(
        ...
        gameMode: this.getGameMode(
          gameMode,
          this.props.electronLoader.getData(ElectronData.RoomSettingsGameMode)
        ),
    ...
    return (
      <Dialog className={styles.createRoomDialog} onClose={props.onCancel}>
        ...
        <form
          ...
          onMouseDown={this.onAction}
        >
          <div className={styles.layout}>
            <div
              className={classNames(styles.verticalLayout, styles.basicInfo)}
            >
              ...
              <div className={styles.inputField}>
                ...
                <select
                  ...
                  disabled={
                    this.gameModeOptions.find((o) => o.checked)?.id !==
                    GameMode.Pve
                  }
                >
