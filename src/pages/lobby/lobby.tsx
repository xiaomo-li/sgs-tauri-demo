...
import { SettingsDialog } from "../ui/settings/settings";
    ...
    return (
      <div className={styles.lobby}>
        ...
        <div className={styles.board}>
            ...
            <div className={styles.gameLog}>
              <div className={styles.gameLogContainer}>
                <Picture
                  ...
                  image={this.gameLogBoardImage}
                />
                <p
                  className={styles.gameLogText}
                  dangerouslySetInnerHTML={{ __html: this.gameLog }}
                />
              </div>
            </div>
            <Button
          ...
          <div
            className={classNames(styles.roomList, {
              [styles.unavailable]: !this.username,
            })}
          >
            {this.roomList.length === 0 && (
              <span>
                {this.props.translator.tr(Messages.noRoomsAvailable())}
              </span>
            )}
            ...
            />
            <Picture
              image={this.roomListBackgroundImage}
          ...
          <div className={styles.systemButtons}>
            ...
            >
              <Picture
                image={this.props.imageLoader.getLobbyButtonImage(
                  LobbyButton.Record
                )}
            ...
            <button
              className={styles.systemButton}
              onClick={this.onClickCharactersList}
            >
              <Picture
                image={this.props.imageLoader.getLobbyButtonImage(
            ...
            <button
              className={styles.systemButton}
              onClick={this.onOpenAcknowledgement}
            >
              <Picture
                image={this.props.imageLoader.getLobbyButtonImage(
          ...
          <Chat
            ...
            username={this.props.electronLoader.getData(
              ElectronData.PlayerName
            )}
        ...
        {this.openFeedback && (
          <FeedbackDialog
            imageLoader={this.props.imageLoader}
            onClose={this.onFeedbackDialogClose}
          />
        )}
        {this.openAcknowledgement && (
          <AcknowledgeDialog
            imageLoader={this.props.imageLoader}
            onClose={this.onCloseAcknowledgement}
          />
        )}
        <div className={styles.version}>
          ...
          {this.updateComplete && (
            <span>{this.props.translator.tr(Messages.updateComplete())}</span>
          )}
          {this.props.translator.trx(
            TranslationPack.translationJsonPatcher(
              "@/core version: {0}",
